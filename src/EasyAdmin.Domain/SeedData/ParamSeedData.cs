...
public class ParamSeedData : IEntitySeedData<ParamEntity>
{
    public IEnumerable<ParamEntity> SeedData()
    {
        return new[]
        {
            new ParamEntity{ Id = 1, ParamName = "是否开启多租户功能", ParamKey = ConfigConst.TenantEnable, ParamValue = "false", State = CommonState.Enable },
            ...
            new ParamEntity{ Id = 3, ParamName = "是否开启注册功能", ParamKey = ConfigConst.UserEnableRegister, ParamValue = "false", State = CommonState.Enable },
