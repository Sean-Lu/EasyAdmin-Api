...
- [x] **通知管理**：系统通知管理，支持系统内通知的创建、编辑、删除和查询
...
- [x] **日报**：个人日报管理，支持日报的创建、编辑、删除和查询
- [x] **周报**：个人周报管理，支持周报的创建、编辑、删除和查询
- [x] **月报**：个人月报管理，支持月报的创建、编辑、删除和查询

### 📊 工具

- [x] **加解密**：常用加密解密工具，支持AES、DES、RSA等加密算法
- [x] **代码生成**：支持数据库模式、代码解析模式、配置模式的代码生成功能
- [x] **百宝箱**：常用效率工具集合，提供随机决策等轻量工具
